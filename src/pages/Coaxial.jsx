...
import diagramaCoaxial from '../assets/coaxial.svg'
...
const Coaxial = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Coaxial | Calculadora de Líneas de Transmisión</title>
        <meta
          name="description"
          content="Calculadora de lineas de transmisión coaxial"
        />
      </Helmet>
      <main className="coaxial__wrapper">
        <h1 className="micro__title">Linea Coaxial</h1>
        ...
        <img src={diagramaCoaxial} alt="" className="coaxial__img" />
